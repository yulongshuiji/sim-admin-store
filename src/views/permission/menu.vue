<template>
  <div class="app-container">
    <el-form :inline="true">
      <el-form-item>
        <el-button v-hasPermi="['permission:menu:add']" type="success" icon="el-icon-plus" size="mini" @click="handleAdd">新增</el-button>
      </el-form-item>
    </el-form>
    ...
    >
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-button
            v-hasPermi="['permission:menu:update']"
            size="mini"
            type="text"
            icon="el-icon-edit"
          ...
          <el-button
            ...
            v-hasPermi="['permission:menu:add']"
            size="mini"
            type="text"
            icon="el-icon-plus"
          ...
          >新增</el-button>
          <el-button
            v-hasPermi="['permission:menu:delete']"
            size="mini"
            type="text"
            icon="el-icon-delete"
