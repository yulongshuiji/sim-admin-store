  ...
  <div>
    ...
    <div class="search-left" style="width: 65%; float: left;">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        <el-form-item v-if="currencyId !== undefined" label="币种" prop="currency_id">
        ...
        <el-form-item v-if="currencyId !== undefined" label="码种" prop="counter_id">
    ...
    <div v-if="dateTime !== undefined" class="search-right" style="width: 35%; float: right; text-align: right; padding-top: 5px;">
    ...
    <el-table v-loading="loading" :data="listData" border max-height="650" :show-summary="true" :summary-method="getSummaries">
      ...
      <el-table-column label="下注区域" align="center" prop="area" width="80" />
...
export default {
  ...
  created() {
    ...
    if(this.numberId !== undefined){
      this.queryParams.number_id = this.numberId
    }
    if(this.parentId !== undefined){
      this.queryParams.parent_id = this.parent_id
    }
